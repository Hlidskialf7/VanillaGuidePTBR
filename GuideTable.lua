...
function objGuideTable:new(oSettings)
	...
	obj.TableDDM = {
		...
		lvl2 = {
			...
			["Guia de Profissão"] = {
				{ "v", "Alquimia", id = nil },
				{ "v", "Ferraria", id = nil },
				{ "v", "[H] Culinaria", id = nil },
				{ "v", "[A] Culinaria", id = nil },
				{ "v", "Encantamento", id = nil },
				{ "v", "Engenharia", id = nil },
				{ "v", "Esfolamento", id = nil },
				{ "v", "Couraria", id = nil }
			},
			["[H] Zonas iniciais"] = {
				{ "s", "Orcs & Trolls" },
	...
	obj.DefineDDMProfessionsSubMenu = function(self)
		xSearchID(obj.TableDDM.lvl2["Guia de Profissão"])
	end

	obj.DefineDDMStartingZonesSubMenu = function(self, tFaction)
		if tFaction == "Horda" then
