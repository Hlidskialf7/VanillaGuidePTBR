...
-----------1-300 Alchemy
	[7002] = {
		title = "1-300 Alquimia",
		--n = "1-300 Alchemy",
		--pID = 1, nID = 10003,
		--itemCount = 14,
		items = {
			[1] = { str = "#NPC1-300 Alquimia#" },
			[2] = { str = "#DOQUESTAprx. mats requeridos#: #VIDEO60#x #TURNINPeacebloom# #VIDEO60#x #TURNINSilverleaf# #VIDEO75#x #TURNINEmpty Vial#" ..
...
-----------1-300 Blacksmithing
	[7003] = {
		title = "1-300 Ferraria",
		--n = "1-300 Blacksmithing",
		--pID = 10002, nID = 10004, 
		--itemCount = 23,
		items = {
			[1] = { str = "#NPC1-300 Ferraria#" },
			[2] = { str = "#DOQUESTAprx. mats requeridos#: #VIDEO90#x #TURNINRough Stone# #VIDEO380#x #TURNINCopper Bar# #VIDEO20#x #TURNINCoarse Stone# " ..
...
-----------1-300 Cooking (Horde & Alliance)
	[7004] = {
		title = "1-300 [H] Culinaria",
		--n = "1-300 Cooking (Horde)",
		--pID = 10003, nID = 10005, 
		--itemCount = 11,
		items = {
			[1] = { str = "#NPC1-300 Culinaria (Horde)#" },
...
-----------1-300 Cooking (Horde & Alliance)
	[7005] = {
		title = "1-300 [A] Culinaria",
		--n = "1-300 Cooking (Alliance)",
		--pID = 10004, nID = 10006, 
		--itemCount = 13,
		items = {
			[1] = { str = "#NPC1-300 Culinaria (Alliance)#" },
			[2] = { str = "#VIDEO[1-40]# 70x Spice Bread (1x Simple Flour, 1x Mild Spices)" },
...
-----------1-300 Enchanting
	[7006] = {
		title = "1-300 Encantamento",
		--n = "1-300 Enchanting",
		--pID = 10005, nID = 10007, 
		--itemCount = 26,
		items = {
			[1] = { str = "#NPC1-300 Encantamento#" },
			[2] = { str = "#DOQUESTAprx. mats requeridos#: " .. 
...
-----------1-300 Engineering
	[7007] = {
		title = "1-300 Engenharia",
		--n = "1-300 Engineering",
		--pID = 10006, nID = 10008, 
		--itemCount = 26,
		items = {
			[1] = { str = "#NPC1-300 Engenharia#" },
			[2] = { str = "#DOQUESTAprx. mats requeridos#: " .. 
...
-----------1-300 Leatherworking
	[7008] = {
		title = "1-300 Esfolamento",
		--n = "1-300 Leatherworking",
		--pID = 10007, nID = 10009, 
		--itemCount = 24,
		items = {
			[1] = { str = "#NPC1-300 Esfolamento#" },
			[2] = { str = "#VIDEO[1-205]# #DOQUESTAprx. mats requeridos#: " .. 
...
-----------1-300 Tailoring
	[7009] = {
		title = "1-300 Couraria",
		--n = "1-300 Tailoring",
		--pID = 10008, nID = 1, 
		--itemCount = 22,
		items = {
			[1] = { str = "#NPC1-300 Couraria#" },
